...
**Live regression:** `./bin/gate-live empty-crm` auto-refreshes to an empty root before scenarios (`--no-refresh` to skip) — see [`docs/manual-checks/2026-06-20-live-gate-program.md`](../../../docs/manual-checks/2026-06-20-live-gate-program.md).
