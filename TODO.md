...
0. [ ] **Provisional validation on step-2 deliver** — Cursor [`1400-provisional-validation-step2-deliver`](prompts/cursor/next/2026-06-14-1400-provisional-validation-step2-deliver.md). Paul + Grok manual test after review.
1. [ ] **Multi-match step-2 deliver truncation** — Cursor [`1410-multi-match-step2-deliver-truncation`](prompts/cursor/next/2026-06-14-1410-multi-match-step2-deliver-truncation.md). After `1400` approved; test uses manufactured provisional row (not live network).
