...
- [ ] **Live gate regression (example networks)** — Opt-in **`./bin/gate-live <network>`** (`baseball`, `crm`, `crm-metering`, `empty-crm`): real `~/mycelium-networks/<network>` + `.env`, per-network YAML catalogs, `@pytest.mark.live_gate` (**never CI**). Design: [`docs/plans/conversations/2026-06-20-live-gate-program.md`](docs/plans/conversations/2026-06-20-live-gate-program.md). Cursor: `prompts/cursor/next/2026-06-20-1600-live-gate-baseball-crm.md`.
