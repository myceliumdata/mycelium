...
- [ ] **Baseball bio specialist — design lock before implement** — **Morning brief:** [`docs/plans/conversations/2026-06-21-baseball-morning-decision-brief.md`](docs/plans/conversations/2026-06-21-baseball-morning-decision-brief.md) (examples + tick boxes). Do not claim Cursor slice until Paul fills Part D answer sheet. Draft prompt: `prompts/cursor/next/2026-06-21-2410-baseball-bio-research-specialist.md`.
