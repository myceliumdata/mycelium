...
- [ ] **Research prompt context enrichment** — MVR-driven bind disambiguation (generalize slice `2000` employer hardcoding → `MvrPolicy.bind_fields`) + peer `context.specialists` in research prompts. Slice `2000` reverted on main; implement in `2026-06-09-2010-research-prompt-full-peer-context`.
...
Last updated: 2026-06-09 (slice 2000 employer hardcode reverted; context enrichment slice 2010 queued)