...
- [ ] **Program 1 — Extended attribute provenance** — **Locked** (hard cutover, no lazy migration). Slices 1–3 **approved** (June 2026); polish `1400` queued. Plan: [`docs/plans/attribute-provenance-program1.md`](docs/plans/attribute-provenance-program1.md). Nits: [`attribute-provenance-program1-polish.md`](docs/plans/attribute-provenance-program1-polish.md). Architecture (Program 2 MVR/entity): [`attribute-provenance-and-storage.md`](docs/plans/attribute-provenance-and-storage.md).
