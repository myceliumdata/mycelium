...
- [x] **Baseball warehouse derive M-track polish** — Intent LLM skip on warm cache, legacy alias read across labels, smoke `intent_dedup_mocked`. Commits `2be1b0e`, `b3ed225`; slice `2026-06-20-1500-baseball-warehouse-derive-m-polish`.
...
Last updated: 2026-06-20 (live gate + M-track polish shipped; computation-centric provenance archived)