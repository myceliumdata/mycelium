...
- [x] **Baseball identity bind on deliver (M2c)** — `debut_team` / `debut_year` from registry bind via `player_identity_specialist`; warehouse `parameters` complete from M2b. Polish nits → `2026-06-19-1700-baseball-warehouse-manifest-m2a-polish`. Hand-test gate ready.
