...
- [ ] **Research peer context prominence** — `PEER SPECIALIST FINDINGS` header missing when `_research_context` flattens peers (shape mismatch in `peer_specialists_for_entity`). Cursor slice `2026-06-09-2110-research-peer-context-prominence`.
...
Last updated: 2026-06-09 (peer context prominence slice 2110 queued)