...
AUTO-GENERATED by Agent Factory on 2026-06-03T17:02:45.147892+00:00.
...
def demographic_specialist(state: MyceliumGraphState | dict[str, Any]) -> dict[str, Any]:
    """
    Specialist agent for the "demographic" category.
    ...
    for c in (current.classifications or []):
        if c.get("category") == "demographic" and c.get("attribute"):
    ...
    logs = [
        f"demographic_specialist: lookup {outcome} for person_key={current.query.person_key!r} (category=demographic).",
