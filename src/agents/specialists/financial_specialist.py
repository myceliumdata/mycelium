...
AUTO-GENERATED by Agent Factory on 2026-06-03T17:08:19.471942+00:00.
Category: financial
...
def financial_specialist(state: MyceliumGraphState | dict[str, Any]) -> dict[str, Any]:
    """
    Specialist agent for the "financial" category.
    ...
    for c in (current.classifications or []):
        if c.get("category") == "financial" and c.get("attribute"):
    ...
    logs = [
        f"financial_specialist: lookup {outcome} for person_key={current.query.person_key!r} (category=financial).",
