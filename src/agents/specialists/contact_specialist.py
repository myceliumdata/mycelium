...
AUTO-GENERATED by Agent Factory on 2026-06-04T08:37:12.158224+00:00.
Category: contact
...
def contact_specialist(state: MyceliumGraphState | dict[str, Any]) -> dict[str, Any]:
    """
    Specialist agent for the "contact" category.
    ...
    for c in (current.classifications or []):
        if c.get("category") == "contact" and c.get("attribute"):
    ...
    logs = [
        f"contact_specialist: lookup {outcome} for person_key={current.query.person_key!r} (category=contact).",
