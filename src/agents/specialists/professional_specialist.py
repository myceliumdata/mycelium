...
AUTO-GENERATED by Agent Factory on 2026-06-04T08:37:03.011996+00:00.
...
def professional_specialist(state: MyceliumGraphState | dict[str, Any]) -> dict[str, Any]:
    """
    Specialist agent for the "professional" category.
    ...
    for c in (current.classifications or []):
        if c.get("category") == "professional" and c.get("attribute"):
    ...
    logs = [
        f"professional_specialist: lookup {outcome} for person_key={current.query.person_key!r} (category=professional).",
