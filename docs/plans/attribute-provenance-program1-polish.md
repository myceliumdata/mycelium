...
| P6 | Slice 3 review | Rows from Slice 3 review | Append during Slice 3 review |
...
- [ ] P1–P10 addressed (P6 rows if Slice 3 adds more)
- [ ] `./bin/ci-local` green
- [ ] No new flat v1 read/write tolerance outside explicit tests for rejection behavior

---

*Last updated: June 2026 (Slice 1–2 review nits)*