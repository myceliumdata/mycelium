...
| P6 | Slice 3+ | Rows from Slice 2 / Slice 3 reviews | Append here during review; address in same polish pass |

---

## Exit criteria

- [ ] P1–P5 addressed (P6 if any rows added)
- [ ] `./bin/ci-local` green
- [ ] No new flat v1 read/write tolerance outside explicit tests for rejection behavior

---

*Last updated: June 2026 (Slice 1 review nits)*